<template>
  <div class="apollo-example">
    ...
    <!-- Tchat example -->
    <ApolloQuery
      :query="require('../graphql/Files.gql')"
    >
      <ApolloSubscribeToMore
        :document="require('../graphql/FileAdded.gql')"
        :update-query="onFileAdded"
      />
...
export default {
  ...
  methods: {
    ...
    onFileAdded (previousResult, { subscriptionData }) {
      console.log(previousResult, subscriptionData)
      return {
        files: [
          ...previousResult.files,
          subscriptionData.data.fileAdded,
        ],
      }
    },
